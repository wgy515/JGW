#include "StdAfx.h"
#include "CJGW_MESGetInfoSomoResponseJson.h"
#include <JGW_FoundationFunc/JGW_StringFunc.h>
namespace JGW
{
    CCJGW_MESGetInfoSomoResponseJson::CCJGW_MESGetInfoSomoResponseJson(void)
    {
    }
    ...
    bool CCJGW_MESGetInfoSomoResponseJson::FromJosn(CCJGW_FTM_Json& msgJson)
    {
        ...
        return true;
         //CCJGW_MESResponseBaseJson::FromJosn(msgJson);
         //msgJson.GetJsonValueToKey<std::string>("paramval",paramval);
         ////！ SONO
