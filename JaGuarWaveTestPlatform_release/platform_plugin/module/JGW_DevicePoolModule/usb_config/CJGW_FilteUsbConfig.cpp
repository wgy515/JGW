...
namespace JGW
{
    ...
    bool CCJGW_FilteUsbConfig::FilteUsbConfigInfo(PS_GUID_USB_CONFIG& psGuidUsbConfig,SDeviceMsg_Info* lpdevice/*,PS_REG_DEVICE_POOL_DEVINFO psRegDevPoolInfo*/)
    {
        //! 如果GUID不相等
//         if (NULL != memcmp(&lpdevice->m_guid,&psRegDevPoolInfo->mGuid,sizeof(GUID)))
//         {
//             return false;
//         }
