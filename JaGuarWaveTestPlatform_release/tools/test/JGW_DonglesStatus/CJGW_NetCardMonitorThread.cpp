...
namespace JGW
{
    ...
    CCJGW_NetCardMonitorThread::CCJGW_NetCardMonitorThread(std::wstring& strNetCardInfo):mpsPcap_t(NULL),mstrNetCardInfo(strNetCardInfo)
    {
    ...
    void CCJGW_NetCardMonitorThread::OnMonitorThread(WPARAM wParam,LPARAM lParam)
    {
        ...
        std::string strName = JGW_W2A(mstrNetCardInfo);
