// JGW_LoggerClient.cpp : 定义控制台应用程序的入口点。
//
...

{
    ...
    append_1->setName( LOG4CPLUS_TEXT("global") );
    ...
    Logger test = Logger::getInstance(  LOG4CPLUS_TEXT("global") );



    LOG4CPLUS_DEBUG(root,"This is" << " a reall" << "y long message." << endl << "Just testing it out" << endl << "What do you think?") ;
