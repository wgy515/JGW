...
namespace JGW
{
    ...
    public:
        ...
        bool BuildSrcPDBFileToPDBBuf(const std::string& saveFolder,bool bDownFireware = true,bool bDownloadOtp = true,bool bDownloadConfig = true);
        //! 下载所有PDB文件
