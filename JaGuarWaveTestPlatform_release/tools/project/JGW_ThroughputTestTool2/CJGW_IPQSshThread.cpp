...
namespace JGW
{
    CCJGW_IPQSshThread::CCJGW_IPQSshThread(bool& bRunTestThread,S_TestParams* psTestParams,CCJGW_AsyncWndMessage* pAsyncWndMessage,Poco::Event& connectEventt) : mbRunTestThread(bRunTestThread),mpsTestParams(psTestParams),mpAsyncWndMessage(pAsyncWndMessage),mb11ADIsConnected(false),m11ADConnectEventt(connectEventt),mbIsUseUbusPrsLinkeInfoCommand(true)
    {
    }
