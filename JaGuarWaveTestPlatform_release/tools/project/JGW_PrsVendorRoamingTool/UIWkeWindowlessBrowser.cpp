...
namespace JGW
{
    ...
    void CWkeWindowlessUI::LoadFile(const std::wstring& strFile)
    {
        m_webView->loadFile(strFile.c_str());
    }

    void CWkeWindowlessUI::LoadUrl(const std::wstring& strUrl)
    {
        m_webView->loadURL(strUrl.c_str());
    }
	...
	void CWkeWindowlessUI::ChangeLegendData(int nIndex,const std::wstring& strStaMac)
	{
		std::wstring strTemp;
	...
	void CWkeWindowlessUI::AddYSeries(const std::wstring& strStaMac)
	{
		std::wstring strTemp;
	...
	//void CWkeWindowlessUI::AddYSeriesData(int nIndex,__int64 nTimeStampMsec,int nPrsRoamingConnectStatus,const std::wstring& strDes)
	//{
	//	std::wstring strTemp;
	//	JGW_FormatWString(strTemp,L"AddLegendData(%d,%I64d,%d,'%s')",nIndex,nTimeStampMsec,nPrsRoamingConnectStatus,strDes.c_str());
	//	jsEvalW(m_webView->globalExec(),strTemp.c_str());
	//}
	void CWkeWindowlessUI::ReloadLocation()
	{
		jsEvalW(m_webView->globalExec(),L"ReloadLocation()");
	}

	void CWkeWindowlessUI::AddYSeriesData(const std::wstring& strMac,__int64 nTimeStampMsec,int nPrsRoamingConnectStatus,const std::wstring& strDes)
	{
		std::wstring strTemp;
    ...
    void CWkeWindowlessUI::StartAutoScroll()
    {
        jsEvalW(m_webView->globalExec(),L"StartAutoScroll()");
    }

    void CWkeWindowlessUI::StopAutoScroll()
    {
        jsEvalW(m_webView->globalExec(),L"StopAutoScroll()");
    }
