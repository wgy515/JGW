...
namespace JGW
{
    ...
    {
        msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_EnArmPrgFileInfo.mfile_buf = NULL;
        msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_NArmPrgFileInfo.mfile_buf = NULL;
    }
    ...
    CCJGW_SSDownloadConfig::~CCJGW_SSDownloadConfig(void)
    {
        ...
        if (msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_EnArmPrgFileInfo.mfile_buf)
        {
            free(msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_EnArmPrgFileInfo.mfile_buf);
            msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_EnArmPrgFileInfo.mfile_buf = NULL;
        }

        if (msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_NArmPrgFileInfo.mfile_buf)
        {
            free(msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_NArmPrgFileInfo.mfile_buf);
            msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_NArmPrgFileInfo.mfile_buf = NULL;
        }
    }
    ...
    bool CCJGW_SSDownloadConfig::LoadSSDwonloadConfig(ps_download_config_info pSDownloadConfigInfo)
    {
        ...
        return LoadContentXMLFile() && LoadArmPrgFile();
    }
    ...
    bool CCJGW_SSDownloadConfig::LoadContentXMLFile()
    {
        ...
        //! EN ARM PRG
        std::string strPath = parese_contents.GetDownloadFilePathToFileName(mpSDownloadConfigInfo->mstrEnArmPrgFileName.c_str());
        JGW_FormatString(mpSDownloadConfigInfo->mstrEnArmPrgFilePath,"%s%s%s",mpSDownloadConfigInfo->mstrDownloadPath.c_str(),strPath.c_str(),mpSDownloadConfigInfo->mstrEnArmPrgFileName.c_str());
        JGW_ReplaceCharA(mpSDownloadConfigInfo->mstrEnArmPrgFilePath,'/','\\');
        //! N ARM PRG
        strPath = parese_contents.GetDownloadFilePathToFileName(mpSDownloadConfigInfo->mstrNArmPrgFileName.c_str());
        JGW_FormatString(mpSDownloadConfigInfo->mstrNArmPrgFilePath,"%s%s%s",mpSDownloadConfigInfo->mstrDownloadPath.c_str(),strPath.c_str(),mpSDownloadConfigInfo->mstrNArmPrgFileName.c_str());
        JGW_ReplaceCharA(mpSDownloadConfigInfo->mstrNArmPrgFilePath,'/','\\');
    ...
    bool CCJGW_SSDownloadConfig::LoadArmPrgFile()
    {
        //! en arm prg
        msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_EnArmPrgFileInfo.mfile_buf = (BYTE*)JGW_GetFileBufToPath_C(mpSDownloadConfigInfo->mstrEnArmPrgFilePath.c_str(),msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_EnArmPrgFileInfo.mfile_len);
        msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_NArmPrgFileInfo.mfile_buf = (BYTE*)JGW_GetFileBufToPath_C(mpSDownloadConfigInfo->mstrEnArmPrgFilePath.c_str(),msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_NArmPrgFileInfo.mfile_len);

        return msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_EnArmPrgFileInfo.mfile_buf && msDownloadAllCommand.msSaharahProtocolArmPrgFile.ms_NArmPrgFileInfo.mfile_buf;
    }
