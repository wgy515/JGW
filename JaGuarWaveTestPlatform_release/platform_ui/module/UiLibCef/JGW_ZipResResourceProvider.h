...
namespace JGW
{
	...
	public:
		...
		~JGW_ZipResResourceProvider();
	public:
		static bool SetZipResResource(HINSTANCE hModuleHandle, DWORD dwResourceNameID, const std::wstring& strResourceType);
        static bool SetZipFilePath(const std::wstring& strZipFilePath);
	protected:
