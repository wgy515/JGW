...
namespace UiLib
{
	...
	CButtonUI::CButtonUI() : m_uButtonState(0), m_dwHotTextColor(0), m_dwPushedTextColor(0), m_dwFocusedTextColor(0),m_dwHotBkColor(0),m_iBindTabIndex(-1),m_bMouseEnterEnabled(false)
    ...
    bool CButtonUI::IsMouseEnterEnabled()
    {
        return m_bMouseEnterEnabled;
    }

    void CButtonUI::SetMouseEnterEnabled(bool bMouseEnterEnabled)
    {
        m_bMouseEnterEnabled = bMouseEnterEnabled;
    }
	...
	void CButtonUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
        ...
        else if( _tcscmp(pstrName, _T("mouseenter")) == 0 ) SetMouseEnterEnabled(_tcscmp(pstrValue, _T("true")) == 0);
