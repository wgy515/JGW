...
namespace UiLib
{
	...
	public:
        ...
        bool	AddChildNode(CTreeNodeUI* pSiblingTreeNodeUI,CTreeNodeUI* _pTreeNodeUI);
		...
		void	IsAllChildChecked(); //?ì2a?ùóD×ó??ê?·??????D 2014.12.11 redrain
	...
	public:
		...
		void SetEnabledMoveNode(bool bMoveNode){m_bEnabledMoveNode = bMoveNode;}
		void SetAllowDiffParentNodeMove(bool bAllow){m_bAllowDiffParentNodeMove = bAllow;}
	...
	private:
		...
		bool m_bEnabledMoveNode;
		bool m_bAllowDiffParentNodeMove;//! 是否允许不同父节点的节点相互移动，默认不允许
	};
}
