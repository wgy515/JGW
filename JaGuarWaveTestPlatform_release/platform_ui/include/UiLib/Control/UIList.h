...
public:
    ...
    void SetNeedEndDown(bool bAutoEndDown = true);

    void SetNeedLineDown(bool bAutoLineDown = true);
...
protected:
    ...
    bool m_bNeedEndDown;
    bool m_bNeedLineDown;
	//int m_iCurSel;
	bool m_bSingleSel;
	CStdPtrArray m_aSelItems;
	CStdPtrArray	m_aIdelListTextElementUi;
    int m_iExpandedItem;
...
/////////////////////////////////////////////////////////////////////////////////////
//
class UILIB_API CListContainerElementUIEx : public CHorizontalLayoutUI, public IListItemUI
{
public:
...
class UILIB_API CListHeaderItemContainer : public CContainerUI
{
public:
	CListHeaderItemContainer();
