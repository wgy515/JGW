// JaGuarWaveHelpV2.cpp : 定义应用程序的入口点。
//
...
#define APPLICATION_WINDOW_NAME L"JaGuarWave Help Application V2"
                     ...
                     int       nCmdShow)
{
    ...
    {
        JGW::CCJaGuarWaveHelpDlgV2* dlg = new JGW::CCJaGuarWaveHelpDlgV2;
#if 0
...
#endif
        dlg->CenterWindow();
        dlg->SetIcon(IDI_JAGUARWAVEHELPV2);
