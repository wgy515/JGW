...
namespace JGW
{
	class CCJaGuarWaveFTPLogBackGroundDlg : public CCAsyncMsgDialog
	{
	public:
		CCJaGuarWaveFTPLogBackGroundDlg(S_HELP_V3_CONFIG& sHelpV3Config);
		~CCJaGuarWaveFTPLogBackGroundDlg(void);
	private:
		//! 初始化窗口
		void OnInitWindow();
		//! 
