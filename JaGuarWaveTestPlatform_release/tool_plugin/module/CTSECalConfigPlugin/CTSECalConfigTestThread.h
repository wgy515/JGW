...
namespace JGW
{
    class CCTSECalConfigTestThread : public CCMessageThread,private CTSE_TestSequenceExec
    {
    public:
        CCTSECalConfigTestThread(void);
        ~CCTSECalConfigTestThread(void);
    public:
    ...
    private:
        ...
        void OnSaveGuCalData(WPARAM wParam,LPARAM lParam);
    private:
        DECLARE_MYTHREAD_MESSAGE_MAP()
    private:
        CCJGW_AsyncWndMessage*  mpAsyncWndMessage;
        PS_TSE_CALCONFIG_TEST_CONFIG_PARAM mpsTSECalConfigTestConfigParam;
    };
