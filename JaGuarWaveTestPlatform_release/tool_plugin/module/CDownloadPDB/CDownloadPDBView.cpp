#include "StdAfx.h"
#include "CDownloadPDBView.h"
#include <JGW_FoundationFunc/JGW_StringFunc.h>
#include <JGW_FoundationFunc/JGW_FilePath.h>

namespace JGW
{
    CCDownloadPDBView::CCDownloadPDBView(void):mpTestThread(NULL),m_nListItemHeight(30)
    {
    ...
    CCDownloadPDBView::~CCDownloadPDBView(void)
    {

    }

    void CCDownloadPDBView::CloseSubWndPlugin()
    {
        if ( mpTestThread )
        {
            delete mpTestThread;
    ...
    bool CCDownloadPDBView::OnIdelTestStatus()
    {
        ...
        ADD_REG_MSG(mpViewResolverParam->mpMapRegMsg,WM_HWND_TEST_LIST_MSG,&CCDownloadPDBView::OnTestListMsg);


        if (!mpTestThread) mpTestThread = new CCDownloadPDBThread;
    ...
    bool CCDownloadPDBView::OnBusyTestStatus()
    {
        mpDoMainList->HomeUp();
    ...
    bool CCDownloadPDBView::OnFailTestStatus()
    {
        mpDoMainList->SetAttribute(L"itemselectedbkcolor",L"0xffff0000");
        return true;
    }

    bool CCDownloadPDBView::OnPassTestStatus()
    {
        return true;
    }

    void CCDownloadPDBView::OnTestListMsg(const WPARAM& wParam,const LPARAM& lParam)
    {
