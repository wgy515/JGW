...
namespace JGW
{
    ...
    public:
        ...
        bool LoadMonitorConfig(const std::wstring strWiFiConfigIniPath,S_WLAN_CONFIG& sWlanConfig);
    private:
    ...
    private:
        ...
        void BuildLoss(size_t nTxChain,size_t channelSize,std::vector<std::vector<float>>& vvLoss,std::vector<std::wstring>& vstrLoss);
    ...
    private:
        ...
        std::vector<std::wstring> mvstrRxLoss;
        std::vector<std::wstring> mvstrTxLoss;
    };
}
