...
namespace JGW
{
    class CCTSEThroughputTestThread : public CCMessageThread,private CTSE_TestSequenceExec
    {
    public:
        CCTSEThroughputTestThread(void);
        ~CCTSEThroughputTestThread(void);
    ...
    private:
        ...
        PS_TSE_THROUGHPUT_TEST_CONFIG_PARAM mpsTSETThroughputTestConfigParam;
    };
}