...
#define SUB_PLUGIN_VERSION L"TSE UI Plugin V1R01_BT"
...
namespace JGW
{
    ...
    typedef struct
    {
        std::wstring mstrUISkinXmlFileName;
        std::vector<std::wstring> mvControlNames;
    }S_UI_CONFIG_INFO,*PS_UI_CONFIG_INFO;
}