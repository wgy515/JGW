/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_CGPS_GNSS/inc/QMSL_CGPS_GNSS.h#24 $
 * $DateTime: 2021/01/06 23:17:36 $
 *
...
/******************************************************************************/
/**
Returns the unblanked IQ data for the last IQ Capture. This is the data reported by the mobile,
via the IQ Data Log, ( CGPS_IQ_DATA_LOG, 0x138A)
...
*******************************************************************************/
QLIB_API unsigned char QLIB_CGPS_GetUnblankedIQ_Data(
   HANDLE hResourceContext,
   char *pI_Samples,
   char *pQ_Samples,
   unsigned long *pNumSamples
...
/******************************************************************************/
/**
Calculate FFT based on the unblanked IQ data.
...
*******************************************************************************/
QLIB_API unsigned char QLIB_CGPS_CalculateUnblankedFFT_Data( HANDLE hResourceContext );
...
/**
   ...
   \param nCollectMode = INPUT, pass collect mode. Default set to 16
...
This function instructs the CGPS GEN9VTv2 engine to track GNSS SV's as specified
by SvTrackParams input parameters. The test can also be stopped using appropriate
   command parameters.
...
\param hResourceContext  = Resource context that was returned from the call to ConnectServer().
\param SvTrackParams     = input. A structure containing Multi-Channel Tracking Test parameters. Please refer to CGPS_Gen9VTv2_SvTrack_Struct_type in QLib_Defines.h
   \endcode
...
*******************************************************************************/
QLIB_API unsigned char QLIB_DIAG_GPS_GEN9VTv2_SV_TRACK( HANDLE hResourceContext,
                                                   void *SvTrackParams,
                                                   unsigned char* piStatus,
                                                   unsigned long* piConstellationMask);


/******************************************************************************/
/*

This function instructs the CGPS GEN9VTv4 engine to track GNSS SV's as specified
by SvTrackParams input parameters. The test can also be stopped using appropriate
command parameters.
...
*******************************************************************************/
QLIB_API unsigned char QLIB_DIAG_GPS_GEN9VTv4_SV_TRACK( HANDLE hResourceContext,
   void *SvTrackParams,
   unsigned char* piStatus,
   unsigned long* piConstellationMask );
...
\return true if successful, false if fail.
*******************************************************************************/
QLIB_API unsigned char QLIB_DIAG_GEN8_GET_FACTORY_EMBEDDED_CALCULATED_CTON(
   HANDLE hResourceContext,
   unsigned char iCollectMode,
   unsigned short iCaptureSize_kSamples,
   unsigned char iNumberOfIntegrations,
...
\return true if successful, false if fail.
*******************************************************************************/
QLIB_API unsigned char QLIB_DIAG_GNSS_GET_FACTORY_EMBEDDED_CALCULATED_CTON(
   HANDLE hResourceContext,
   unsigned char iCollectMode,
   unsigned short iCaptureSize_kSamples,
   unsigned char iNumberOfIntegrations,
...
QLIB_API unsigned char QLIB_DIAG_GNSS_GET_FACTORY_EMBEDDED_CALCULATED_CTON_ALL_CONSTELLATIONS(
   HANDLE hResourceContext,
   unsigned char iCollectMode,
   unsigned short iCaptureSize_kSamples,
   unsigned char iNumberOfIntegrations,
...
QLIB_API unsigned char QLIB_GNSS_SpecAn_Control_V3(HANDLE hResourceContext,
	unsigned char SCAN_MODE,
	unsigned char SCAN_START_STOP,
	unsigned char GPS_SCAN_TYPES_ENABLED,
	unsigned char GLO_SCAN_TYPES_ENABLED,
	...
	unsigned char RESET_NOTCH_FILTERS,
	unsigned char BDS_SCAN_TYPES_ENABLED,
	unsigned char GAL_SCAN_TYPES_ENABLED
);

QLIB_API unsigned char QLIB_GNSS_SpecAn_Control_V4(HANDLE hResourceContext,
	unsigned char SCAN_MODE,
	unsigned char SCAN_START_STOP,
	unsigned char GPS_SCAN_TYPES_ENABLED,
	unsigned char GLO_SCAN_TYPES_ENABLED,
	...
	unsigned char BDS_SCAN_TYPES_ENABLED,
	unsigned char GAL_SCAN_TYPES_ENABLED,
	unsigned char GPSL5_SCAN_TYPES_ENABLED
);

QLIB_API unsigned char QLIB_GNSS_SpecAn_Control_V5( HANDLE hResourceContext,
   unsigned char SCAN_MODE,
   unsigned char SCAN_START_STOP,
   unsigned char GPS_SCAN_TYPES_ENABLED,
   unsigned char GLO_SCAN_TYPES_ENABLED,
   ...
   unsigned char GAL_SCAN_TYPES_ENABLED,
   unsigned char GPSL5_SCAN_TYPES_ENABLED,
   unsigned char NavIc_SCAN_TYPES_ENABLED,
   unsigned char GalE5_SCAN_TYPES_ENABLED
);
...
\param XTAL                    The XTAL package used: 1 = TCXOMGR_XTAL_2016 
                                                      2 = TCXOMGR_XTAL_2520 
                                                      3 = TCXOMGR_XTAL_2016_38_4_MHz
                                                      4 = TCXOMGR_XTAL_1612_38_4_MHz
...
\param XTAL                    The XTAL package used: 1 = TCXOMGR_XTAL_2016 
                                                      ...
                                                      3 = TCXOMGR_XTAL_2016_38_4_MHz
                                                      4 = TCXOMGR_XTAL_1612_38_4_MHz
\param MinTemp                 The min temperature in DegC 
\param MaxTemp                 The max temperature in DegC 
\param piStatus                Pointer to where the status will be stored 
\param iTimeoutValue           Number of miliseconds to wait for response. 
\param pPostProcessor          Class to do WBIQ Post Processing at the end of each embedded WBIQ test 
\param sIQ_Filename            IQ Data file name.  Set to NULL to not collect IQ data 
...
\return true if successful, false if fail 
****************************************************************************/
QLIB_API unsigned char QLIB_GNSS_XO_Factory_Cal_Request_PlusTemp_WithWait(HANDLE          hResourceContext,
                                                                 unsigned long   RX_FREQ_KHZ,
                                                                 long            OFFSET,
                                                                 short           POWER_LEVEL,
                                                                 unsigned char   XTAL,
...
This function sends the GNSS_START_PFA_TEST DM command to the phone returning the command response.

\param hResourceContext  = Resource context that was returned from the call to ConnectServer(). 
\param pvRequest  = Request. Please refer to gnss_PFA_test_cmd_req in QLib_Defins.h
 
\param pvResponse = Response. Please refer to gnss_PFA_test_cmd_rsp in QLib_Defins.h
...
*******************************************************************************/
QLIB_API unsigned char QLIB_GNSS_START_PFA_TEST( HANDLE hResourceContext,
                                                 void *pRequest,
                                                 void *pResponse);
...
/******************************************************************************/
/**
This function instructs the Location engine to enable or disable all blanking.

This command will check the status field and return false if the command was rejected.

\param enable                      = 1: enable all blanking, 0: disable all blanking
...
*******************************************************************************/
QLIB_API bool QLIB_DIAG_GNSS_CONFIG_ALL_BLANKING(
   HANDLE hResourceContext,
   char enable,
   char & iStatus
);
