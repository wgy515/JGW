/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_Connectivity/inc/QMSL_Connectivity_WiGig/QMSL_Connectivity_WiGig.h#29 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   This function sends a command to DmTools.

   \param command = command string.
   \code
   Example: "FLOWS|BB_SendTone|127.0.0.1:12348@PCI!wmp0|2,3"
   Example: "ut_command|a|hw_sysapi_get_bb_status_block_2|127.0.0.1:12348@PCI!wmp0"
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WIGIG_SendCommand(
	   HANDLE hResourceContext,
	   char* command,
	   char* response);
