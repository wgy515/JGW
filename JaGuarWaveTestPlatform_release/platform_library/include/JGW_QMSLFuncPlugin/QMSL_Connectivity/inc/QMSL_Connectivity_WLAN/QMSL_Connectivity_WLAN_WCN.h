/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_Connectivity/inc/QMSL_Connectivity_WLAN/QMSL_Connectivity_WLAN_WCN.h#7 $
 * $DateTime: 2017/04/18 12:42:17 $
 *
 *
 ******************************************************************************
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   GEN6 WLAN Commands:  QLIB_FTM_WLAN_GEN6_xLNAcal

   \param lna DUT output xLNA cal value

   \param gm DUT output xLNA gm value

   \return true if successful, false if failure

   \warning QLIB_FTM_WLAN_GEN6_START() must be called first to start WLAN test mode
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_WLAN_GEN6_xLNAcal
   (
      HANDLE hResourceContext,
	  unsigned char *lna,
	  unsigned char *gm
