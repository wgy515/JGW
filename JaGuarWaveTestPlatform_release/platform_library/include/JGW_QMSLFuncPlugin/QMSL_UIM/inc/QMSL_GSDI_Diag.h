/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_UIM/inc/QMSL_GSDI_Diag.h#13 $
 * $DateTime: 2020/01/19 19:54:25 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   This function allows the user to change the SIMLOCK RSU mode configuration.

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param rsumode = Simlock RSU mode, look at the section 7.22 for details. 
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_SIMLOCK_SET_RSU_MODE_CMD(HANDLE hResourceContext, unsigned char rsumode, unsigned long *status);

   /******************************************************************************/
   /**
   This function allows to provision the DEVICE_KEY in the terminal.

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param rsusymmetrickey = DEVICE_KEY to provision in the terminal. 32bytes 
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_SIMLOCK_SET_RSU_KEY_CMD(HANDLE hResourceContext, unsigned char rsusymmetrickey[32], unsigned long *status);
