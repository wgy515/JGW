/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/QMSL_NV/NV_Manager/QMSL_Linear_Predistortion_NV.h#8 $
...
/******************************************************************************/
   /**
   public static  removeDcComponent

   Removes DC component from the two input vectors. Inputs are 2 vectors their sizes.
   ...
   \return none
   *******************************************************************************/
   static void removeDcComponent(float* dest1, float* dest2, const float * CVec1,const float * CVec2, long CVec1Size, long CVec2Size);
