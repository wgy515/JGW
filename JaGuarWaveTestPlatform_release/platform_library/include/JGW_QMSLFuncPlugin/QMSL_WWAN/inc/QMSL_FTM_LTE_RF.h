/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_FTM_LTE_RF.h#15 $
 * $DateTime: 2017/09/28 00:20:13 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE RF Commands (80-VR832-1) QLIB_FTM_LTE_SET_TX_SYS_BW

   This command configures the phone Tx System Bandwidth for LTE CAT-M1.
   ...
   \warning
   *******************************************************************************/   
   QLIB_API unsigned char QLIB_FTM_LTE_SET_TX_SYS_BW( HANDLE hResourceContext, unsigned char itxChanBW );
   
   /******************************************************************************/
   /**
   Factory Test Mode LTE RF Commands (80-VR832-1) QLIB_FTM_LTE_SET_RX_SYS_BW

   This command configures the phone Rx System Bandwidth for LTE CAT-M1.
   ...
   \warning
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_SET_RX_SYS_BW( HANDLE hResourceContext, unsigned char irxChanBW );

   /******************************************************************************/
   /**
   Factory Test Mode LTE RF Commands (80-VR832-1) QLIB_FTM_LTE_SET_TX_NB_REGION

   This command configures the phone Tx Narrowband Region for LTE CAT-M1.

   \param hResourceContext = Resource context that was returned from the call to ConnectServer()

    \param itxNb = (start RB)    		
		   1.4MHz-range 0
		   3MHz-range 0~9
		   5MHz-range 0~19
		   10MHz-range 0~44
   ...
   \warning
   *******************************************************************************/      
   QLIB_API unsigned char QLIB_FTM_LTE_SET_TX_NB_REGION( HANDLE hResourceContext, unsigned char itxNb );

   /******************************************************************************/
   /**
   Factory Test Mode LTE RF Commands (80-VR832-1) QLIB_FTM_LTE_RX_NB_RETUNE

   This command configures the phone Rx Narrow Band Region to retune to for LTE CAT-M1.

   \param hResourceContext = Resource context that was returned from the call to ConnectServer()

    \param irxNb= ( which 10MHz)
		   15MHz-range 0,1
		   20MHz-range 0,1,2
   ...
   \warning
   *******************************************************************************/  
   QLIB_API unsigned char QLIB_FTM_LTE_RX_NB_RETUNE( HANDLE hResourceContext, unsigned char irxNb );
   ...
   *******************************************************************************/
   ...
   /////////////////////////////////////////////////////////////////////////////////////////
   // NB-IOT Commands , will be adding documentation later
   QLIB_API unsigned char QLIB_FTM_NB_SET_TX_WAVEFORM( HANDLE hResourceContext, unsigned char iTxModulation, unsigned char iToneBW, unsigned char iToneStartIdx , char iTxPWRDBM , unsigned char & status );
   QLIB_API unsigned char QLIB_FTM_LTE_NB_SET_UL_CARRIER_FREQ_OFFSET( HANDLE hResourceContext , char ul_carrier_freq_offset , unsigned char & status );
   QLIB_API unsigned char QLIB_FTM_LTE_NB_ENABLE_RX( HANDLE hResourceContext , unsigned char nb_enable_rx , unsigned char & status );
   QLIB_API unsigned char QLIB_FTM_NB_STOP_TX_WAVEFORM( HANDLE hResourceContext,unsigned char & status);
   QLIB_API unsigned char QLIB_FTM_LTE_SET_NB_MODE(HANDLE hResourceContext, unsigned char iNbMode, unsigned char & iStatus);
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
