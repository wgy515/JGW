/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_FTM_LTE_NS.h#24 $
 * $DateTime: 2017/10/30 17:30:31 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   Factory Test Mode LTE Commands QLIB_FTM_LTE_NS_HANDOVER_ENH
   ...
   \param iNumRx          = The number of receivers to be used for PCC for this NS session
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NS_HANDOVER_ENH( HANDLE hResourceContext, unsigned char iBand, unsigned long iEARFCN, unsigned char iNumRx, unsigned long* pStatus );
