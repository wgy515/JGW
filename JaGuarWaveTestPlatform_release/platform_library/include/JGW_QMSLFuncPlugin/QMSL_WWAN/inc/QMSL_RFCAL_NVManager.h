/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_RFCAL_NVManager.h#35 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /**
   Generate the Cx NV item associated with GSM linear Tx DA calibration
         with extended RGI list data type
   */
   QLIB_API unsigned char QLIB_RFCal_GSM_Tx_DA_Cal_Extended_RGI_Generate_NV
   (   HANDLE hResourceContext,
      unsigned short iNvModeId,
      unsigned char iChainId,
      void* aGSM_DA_Cal,
   ...
   *******************************************************************************/
   ...
   /*******************************************************************************/
   /**
   Generate the Cx NV item associated with GSM linear Tx DA for Extended RGI and
   pre-distortion calibration.
   */
   QLIB_API unsigned char QLIB_RFCal_GSM_Tx_DA_Cal_IQ_Predist_Cal_Extended_RGI_Generate_NV
   (   HANDLE hResourceContext,
      unsigned short iNvModeId, unsigned char iChainId,
      void* aGSM_DA_Cal,
      void* aGSM_PreDist_Cal,
   ...
   /*******************************************************************************/
      QLIB_API unsigned char QLIB_RFCal_GSM_Tx_DA_Cal_IQ_Predist_Cal_Generate_Tree_NV
      (   HANDLE hResourceContext,
      unsigned short iNvModeId,
      unsigned char txAntPath,
      unsigned char rfmDevice,
   ...
   */
   ...
   /******************************************************************************/
   /**
   Generate the NV items associated with GSM DC offset calibration. The NV items includes
   QMSL_GSM_Rx_DC_Calibration_NV

   \param hResourceContext   Resource context that was returned from the call to QLIB_ConnectServer().

   \param iNvModeId [input] Enumeration of nv_mode_id_type.  The NV mode ID determines the set of NV items to be generated.  See QLib_Defines.h for definition

   \param aGSM_Rx_DC_Calibration_Meas_n_Params [input] Pointer to
          QMSL_GSM_Rx_DC_Calibration_Params_and_Meas, GSM DC offset calibration values.  
          See QLib_Defines.h for details

   \param aGSM_Rx_DC_Calibration_NV [output] Pointer to
          QMSL_GSM_Rx_DC_Calibration_NV. 
          See QLib_Defines.h for details
   ...
   \warning NV items are not written to the mobile station until QLIB_RFCAL_NV_Manager_WriteToPhone() is called
   */
   QLIB_API unsigned char QLIB_GSM_RX_DC_CALIBRATION_GENERATE_NV(
   HANDLE hResourceContext,
   unsigned short iNvModeId,
   void* aGSM_Rx_DC_Calibration_Meas_n_Params,
   void* aGSM_Rx_DC_Calibration_NV,
   unsigned char bCachedByNVManager
);
   ...
   *******************************************************************************/
   ...
   \param iListofNVIDs, list of NVID

   \warning This function always return 1;
   *******************************************************************************/
   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_Copy_RFNV_Items_From_NV_Tool_With_NVIDLists(HANDLE hResourceContext,
       unsigned short* iNumOfItemsCopied, unsigned short * iListofNVIDs);

   /******************************************************************************/
   /**
   Remove RFNV from NV Manager

   This function removes RFNV item from NV manager 

   \param iNumOfNVItems, the number of items to be removed from NVmanager

   \param nvid_list, NVID Lis to be removed.

   \warning This function always return 1;
   *******************************************************************************/
   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_Remove_RFNV_Items(HANDLE hResourceContext,
	   unsigned short * iNumOfNVItems, unsigned short * nvid_list);
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
      /**
   Generate Enh Sweep Calibration NV for modem CT
   This function will get a list of sweep records that correspond
   to all measurment performed during calibration - and will walk
   through those measurement and generate multilin_v3, hdet_vs_agc,
   lim_vs_freq, lna_offset_vs_freq and dvga_vs_freq NV items
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_RFCAL_Generate_ESC_Tx_NV_V2(   HANDLE hResourceContext,
         unsigned short iNvModeId,
         unsigned short iNVPath,
         unsigned short numRecords,
         unsigned long refChan,
...
/**
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_RFCAL_Process_CommonCAL_ESC_Consolidated_Rx_NV(   HANDLE hResourceContext,
      ...
      /*******************************************************************************/
   /**
   QLIB_RFCAL_NV_Manager_Merge_XQCN - Merge two QCNs into one xqcn with filters (output is Path1)

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] sXQCN_FilePath1 = file path to xqcn 1

   \param [in] sXQCN_FilePath2 = file path to xqcn 2

   \param [in] num_filters = num of filters

   \param [in] filters = filter data (e.g., RFCAL_NV_MERGE_FILTER_TYPE_0 in Qlib_Defines.h)
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_Merge_XQCN(HANDLE hResourceContext, const char* sXQCN_FilePath1, const char * sXQCN_FilePath2, unsigned int num_filters, void * filters, unsigned long * error_code);


   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_V2_Load_XQCN(HANDLE hResourceContext, const char* sXQCN_FilePath);

   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_V2_Write_To_Phone(HANDLE hResourceContext, unsigned long* error_code);

   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_V2_Get_PathData(HANDLE hResourceContext, unsigned int option, unsigned int num_filters, void * filters, unsigned int * iSizeResData, unsigned char * resData, unsigned long * error_code);

   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_V2_Set_PathData(HANDLE hResourceContext, unsigned int option, unsigned int nvid, unsigned int iSizeData, unsigned char * data_to_add, unsigned long * error_code);

   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_V2_Read_NV_from_phone(HANDLE hResourceContext, unsigned short nvid, unsigned int * ierr_code);

   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_V2_Get_NVID_List(HANDLE hResourceContext, unsigned int iOption, unsigned int * nvid_list_size, unsigned short * nvid_list, unsigned long * iErr_Code);

   QLIB_API unsigned char QLIB_RFCAL_NV_Manager_V2_Clear_Data(HANDLE hResourceContext, unsigned long * ierr_code);
