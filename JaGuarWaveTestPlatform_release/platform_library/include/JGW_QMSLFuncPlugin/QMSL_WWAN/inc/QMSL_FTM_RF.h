/******************************************************************************
 * *$Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_FTM_RF.h#161 $
 * *$DateTime: 2021/12/22 22:00:16 $
 *
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_GET_ADC_VAL( HANDLE hResourceContext, unsigned short iADC_type, unsigned short* piADC_value );
   ...
   *******************************************************************************/
   ...
   This function forces the AMSS to select the Rx chain for all CDMA 1x processing in online
   mode/ FTM mode. This test mode is intended for production testing of the second receive chain functionality.
   The phone will now only respond to forward link signals on the selected chain. All transmit functions
   continue to use the primary antenna port. The phone will return to normal operation after a reset, or a
   Second Chain Test Call Mode command with the mode set to Disable.
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_CDMA_SRCH_DIAG_RX_CHAIN_SELECT( HANDLE hResourceContext, unsigned char iMode );
   ...
   *******************************************************************************/
   ...
   \param maatMode            MAAT mode to program
   \param atScenario          AT scenario index to program
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_ANT_TUNER_SET_TUNER_PROPERTIES( HANDLE hResourceContext,
                                                                      ...
                                                                      unsigned char maatMode = 0,
                                                                      unsigned char atScenario = 0);

   /******************************************************************************/
   /**
   FTM RF Antenna Tuner Commands ICD (80-PF657-903) SET ALL TUNER PROPERTIES

   This command will program all active tuners.

   \param hResourceContext    Resource context that was returned from the call to QLIB_ConnectServer()
   \param version             Subcommand version
   \param updateType          Tunecode update type (see ftm_rf_ant_tuner_update_all_tuner_enum_type)

   \return true if successful, false if fail.

   \warning
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_ANT_TUNER_SET_ALL_TUNER_PROPERTIES( HANDLE hResourceContext,
                                                                          unsigned short version,
                                                                          unsigned char updateType);
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_TEST_CMD_RADIO_CONFIGURE_V2(  HANDLE hResourceContext,
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_TEST_CMD_RX_MEASURE_BLOB API is used to get the Rx power measurements from the phone using the FTM-RF-TEST subsystem and process multiple blob types
   ...
   \param [out] responseBlobData = Pointer to Array of Response Properties for Blob type
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_UNIFIED_QUERY_RECOMMENDED_RADIO_ALLOCATION API is used to get the RF device and sig_path info from the phone using the Unified Query Command
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_UNIFIED_QUERY_RECOMMENDED_RADIO_ALLOCATION(  HANDLE hResourceContext,
                                                                                void* request_data,
                                                                                void* respsonse_data,
                                                                                unsigned long* error_code,
                                                                                unsigned long* specific_err_code );
   ...
   *******************************************************************************/
   ...
   /**
   QLIB_FTM_RF_TEST_CMD_QUERY_RECOMMENDED_RADIO_ALLOCATION_FETCH_BLOB API is used to get the RF device and sig_path info from the phone using the FTM-RF-TEST subsystem
   ...
   \param [out] response_blob_data = Pointer to Array of Response blob data
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_RF_TEST_CMD_QUERY_RECOMMENDED_RADIO_ALLOCATION_FETCH_BLOB(HANDLE hResourceContext,
                                                                                             void* request_data,
                                                                                             void* respsonse_data,
                                                                                             void* response_blob_data,
                                                                                             unsigned long* error_code,
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_TEST_CMD_SLEEP_CONTROL API is used to send a Sleep Control command
   to the phone using the FTM-RF-TEST subsystem
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_TEST_CMD_SLEEP_CONTROL(  HANDLE hResourceContext,
                                                               void* request_data,
                                                               void* respsonse_data,
                                                               unsigned long* error_code,
                                                               unsigned long* specific_err_code );
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_TEST_CMD_COMMAND_CAPABILITY_QUERY API is used to query the supported RF Test commands and properties
   to the phone using the FTM-RF-TEST subsystem
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_TEST_CMD_COMMAND_CAPABILITY_QUERY(  HANDLE hResourceContext,
                                                            unsigned long subscriber,
                                                            unsigned long technology,
                                                            void* request_data,
                                                            void* respsonse_data,
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_SET_TECH_TRM_ANT_PORT_STATE API is used to set the port position for Port A/Port B testing per standalone technology

   \param technology = ftm_rf_technology_type definition
   
   \param carrier_id = Carrier ID

   \param sub_id = Subscriber type
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_SET_TECH_TRM_ANT_PORT_STATE( HANDLE hResourceContext, unsigned char technology, unsigned char carrier_id, unsigned char sub_id, unsigned char switch_position, unsigned char* trm_result, unsigned char *error_code);
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_GET_TECH_TRM_ANT_PORT_STATE API is used to set the port position for Port A/Port B testing per each standalone technology
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_GET_TECH_TRM_ANT_PORT_STATE( HANDLE hResourceContext, unsigned char technology, unsigned char carrier_id, unsigned char sub_id, unsigned char* error_code, unsigned char* current_port_status,unsigned char* current_cal_status,unsigned char* pending_port_status,unsigned char* pending_cal_status);
   ...
   *******************************************************************************/
   ...
   This command is applicable to
	 ...
	 QLIB_FTM_CALL_RFNV_READ_V3
	 QLIB_FTM_CALL_RFNV_WRITE_V2
	 QLIB_FTM_CALL_RFNV_WRITE_V3
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_TECH_ENTRY: Use FTM RF Debug framework to set up radio
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_DEBUG_CMD_TECH_ENTRY(  HANDLE hResourceContext,
                                                                  unsigned long technology,
                                                                  void* request_data,
                                                                  void* respsonse_data,
                                                                  unsigned long* error_code,
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_IDC_CAL: Use FTM RF Debug framework to do Internal Device Calibration

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair to perform IDC Cal

   \param [out]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair from IDC Cal data

   \return true if successful, false if fail.

   *******************************************************************************/
   unsigned char QLIB_FTM_RF_DEBUG_CMD_IDC_CAL(    HANDLE hResourceContext,
                                                   unsigned long technology,
                                                   void* request_data,
                                                   void* respsonse_data,
                                                   unsigned long* error_code,
   ...
   unsigned char QLIB_FTM_RF_DEBUG_CMD_IDC_CAL_AND_FETCH_IQ_DATA(    HANDLE hResourceContext,
                                                                     unsigned long technology,
                                                                     void* request_data,
                                                                     void* response_data,
                                                                     unsigned char* num_blobs,
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_LOAD_UNITY_DPD: Use FTM RF Debug framework to load Unity DPD

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair to load Unity DPD

   \param [out]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair from load Unity DPD
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_VDPD_CAL: Use FTM RF Debug framework to do VDPD Cal

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair to do VDPD Cal

   \param [out]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair from VDPD Cal data
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_VDPD_CONVERSION: Use FTM RF Debug framework to convert VDPD

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair to perform VDPD Conversion

   \param [out]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair from VDPD Conversion data
   ...
   *******************************************************************************/
   ...
   \param [in]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair to load DPD

   \param [out]   pointer to ftm_rf_debug_property_data.  This data structure holds the (property, value) pair from DPD data
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_DCOC_OVERRIDE: Use FTM RF Debug framework to Set DPD Debug Mode
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_RF_DEBUG_CMD_DCOC_OVERRIDE(HANDLE hResourceContext,
       unsigned long technology,
       void* request_data,
       void* respsonse_data,
       unsigned long* error_code,
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_INTERNAL_DEVICE_CAL: Use FTM RF Debug framework to support Device cal such as DAC Cal etc.
   ...
   \return true if successful, false if fail.
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_DEBUG_CMD_INTERNAL_DEVICE_CAL(  HANDLE hResourceContext,
                                                            unsigned long technology,
                                                            void* request_data,
                                                            void* respsonse_data,
                                                            unsigned long* error_code,
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_RF_DEBUG_CMD_INTERNAL_DEVICE_CAL_BLOB API is used to support Device cal such as DAC/ADC Cal with response include Blob Data.
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RF_DEBUG_CMD_INTERNAL_DEVICE_CAL_BLOB(  HANDLE hResourceContext,
                                                            unsigned long technology,
                                                            void* request_data,
                                                            void* respsonse_data,
                                                            void* response_blob_data,
   ...
   *******************************************************************************/
   ...
   \param [in]   pointer to ftm_qlink_property_data.  This data structure holds the (property, value) pair to perform SHMOO Plot test

   \param [out]   pointer to ftm_qlink_property_data.  This data structure holds the (property, value) pair from SHMOO Plot test
   ...
   *******************************************************************************/
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_QLINK_ENUM_CYCLE_TEST: Run a QLINK ENUM Cycle Test

   This command triggers the start of a cycle that loops a user defined number of times. 
   The cycle type is defined by FTM_QLNK_ENUM_CYCLE_TEST_TYPE see 2.8.2 
   The default number of cycles is ten. The maximum number of cycles is 200 and the minimum is 2. 
   Before entering the cycle phase the QLink stack is started. 


   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in]   pointer to ftm_qlink_property_data.  This data structure holds the (property, value) pair to perform ENUM Cycle test

   \param [out]   pointer to ftm_qlink_property_data.  This data structure holds the (property, value) pair from ENUM Cycle test
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_QLINK_ENUM_CYCLE_TEST(  HANDLE hResourceContext,
                                                           void* request_data,
                                                           void* respsonse_data,
                                                           unsigned long* error_code,
                                                           unsigned long* specific_err_code );
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_QLINK_ENUM_CYCLE_TEST_SUBSYS128: Run a QLINK ENUM Cycle Test
   ...
   \param [out]   pointer to ftm_qlink_property_data.  This data structure holds the (property, value) pair from Cycle test
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_QLINK_ENUM_CYCLE_TEST_SUBSYS128(  HANDLE hResourceContext,
                                                                     void* request_data,
                                                                     void* respsonse_data,
                                                                     unsigned long* error_code,
                                                                     unsigned long* specific_err_code );
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_QLINK_SHMOO_PLOT_TEST_V2: Run a eye plot test on QLINK on HE based modem 

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in]   pointer to ftm_qlink_property_data_v2.  This data structure holds the (property, value) pair to perform shmoo plot test v2

   \param [out]   pointer to ftm_qlink_property_data_v2.  This data structure holds the (property, value) pair from shmoo plot test v2
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_QLINK_SHMOO_PLOT_TEST_V2(  HANDLE hResourceContext,
                                                              void* request_data,
                                                              void* response_data,
                                                              unsigned long* error_code,
                                                              unsigned long* specific_err_code,
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_QLINK_QSLEEP_TEST: Run a eye plot test on QLINK on HE based modem 
   
   This command will enabled QSleep - Execute CSR Writes - Disable QSleep - Execute CSR Writes

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in]   pointer to ftm_qlink_property_data.  This data structure holds the (property, value) pair to perform QSLEEP test

   \param [out]   pointer to ftm_qlink_property_data.  This data structure holds the (property, value) pair from QSLEEP test
   ...
   *******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_QLINK_QSLEEP_TEST(  HANDLE hResourceContext,
                                                       void* request_data,
                                                       void* respsonse_data,
                                                       unsigned long* error_code,
                                                       unsigned long* specific_err_code );
   ...
   /********************************************************************************/
   /**
   QLIB_FTM_QLINK_SHMOO_PLOT_TEST_V3: Run a eye plot test on QLINK on HI based modem 
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_QLINK_SHMOO_PLOT_TEST_V3(  HANDLE hResourceContext,
                                                              void* request_data,
                                                              void* response_data,
                                                              unsigned long* error_code,
                                                              unsigned long* specific_err_code,
   ...
   /******************************************************************************/
   /**
   QLIB_FTM_QLINK_CHECK_LINK_PLOT_TEST - 
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_QLINK_CHECK_LINK_PLOT_TEST(HANDLE hResourceContext,
       void* request_data,
       void* response_data,
       unsigned long* error_code,
       unsigned long* specific_err_code);
    ...
    /******************************************************************************/
   /**
   QLIB_FTM_QLINK_INDEPENDENT_SCREENING_TEST - 
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_QLINK_INDEPENDENT_SCREENING_TEST(HANDLE hResourceContext,
       void* request_data,
       void* response_data,
       unsigned long* error_code,
       unsigned long* specific_err_code);
   ...
   *******************************************************************************/
   ...
   QMSL_FTM_COMMON_ACTIVATE_FTM_PROTOCOL - SETS DEVICE IN FTM
   
   THIS COMMAND IS NOT EXPECTED TO WORK ON ALL TARGETS - ONLY CERTAIN TARGETS SUPPORT THIS COMMAND

   CUSTOMERS ARE REQUESTED TO USE THE STANDARD FTM SET MODE COMMAND

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] requestData = None

   \param [out] responseData = None
   
   ***********************************************************************************/

   QLIB_API unsigned char QLIB_FTM_COMMON_ACTIVATE_FTM_PROTOCOL( HANDLE hResourceContext );

      /*******************************************************************************/
   /**
   QLIB_FTM_RPC_ExecuteSingleResponse -
        Generic FTM RPC command execution,
        where one final delayed response is expected after the imm response

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] requestData = Pointer to buffer of request data bytes as const char *

   \param [in] requestData = Number of valid bytes pointed to by requestData param

   \param [in] iTimeOutMS = Timeout in MS for all of delayed responses to arrive

   \param [in] responseHandler = Function pointer to handle each delayed response payload.
                                Function is called once for each delayed response sent by RPC handler.
                                Callback receives the following params:
                                    unsigned int status          : status field set in Diag subsys v2 response
                            unsigned char* resp_data     : Payload of response (not incl. the 16-byte Diag header)
                            unsigned short resp_data_len : Number of valid bytes in resp_data
                            unsigned char is_last        : If the final response flag was set in Diag "rsp_cnt" field,
                                                                   indicating this is the last response

   \param [out] errMsgOut = Will be set to an error message string if an error occurred. Caller need not allocate.
                            The pointer will be set to a const char *

   \return true if successful, false if fail.
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RPC_ExecuteSingleResponse(HANDLE hResourceContext,
                                                             unsigned int cmd,
                                                             const char* requestData,
                                                             unsigned short requestDataLen,
                                                             unsigned long iTimeOutMS,
                                                             unsigned int * status,
                                                             unsigned char* resp_data,
                                                             unsigned short* resp_data_len,
                                                             const char ** errMsgOut);

   /*******************************************************************************/
   /**
   QLIB_FTM_RPC_ExecuteMultiResponse -
        Generic FTM RPC command execution
        where multiple delayed responses are expected, after the initial immed response.
   ...
   \param [in] responseHandler = Function pointer to handle each delayed response payload.
                                Function is called once for each delayed response sent by RPC handler.
                                It is not called for the immediate response
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RPC_ExecuteMultiResponse(   HANDLE hResourceContext,
                                                               unsigned int cmd,
                                                               const char* requestData,
                                                               unsigned short requestDataLen,
                                                               unsigned long iTimeOutMS,
   ...
   /*******************************************************************************/
   /**
   QLIB_FTM_RPC_ExecuteMultiResponse_NoCallback -
        Generic FTM RPC command execution
        where multiple delayed responses are expected, after the initial immed response.
   ...
   \param [in] unsigned char* resp_data     : Payload of delayed response (not incl. the 16-byte Diag header)
   \param [in] unsigned int * resp_data_len : Number of valid bytes in resp_data
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_RPC_ExecuteMultiResponse_NoCallback(HANDLE hResourceContext,
                                                            unsigned int cmd,
                                                            const char* requestData,
                                                            unsigned short requestDataLen,
                                                            unsigned long iTimeOutMS,
   ...
   \param [in] sleepMode = Sleep mode for NR Rx chains

   \param [in] sleepRxDevices = Array of bytes to put specified NR Rx devices to sleep (Required on HI4.3)

   \param [in] sleepRxChains = Array of bytes to put specified NR Rx chains to sleep

   \return true if successful, false if fail.

   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_NR5G_SLEEP( 
      HANDLE hResourceContext,
      byte sleepMode,
      byte* sleepRxDevices,
      byte sleepRxDevicesLen,
      byte* sleepRxChains,
      byte sleepRxChainsLen );

   /*******************************************************************************/
   /**
   QLIB_FTM_NR5G_WAKEUP -

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] wakeupMode = Wakeup mode for NR Rx chains previously put to sleep

   \param [in] awakenRxDevices = Array of bytes to awaken specified NR Rx devices (Required on HI4.3)

   \param [in] awakenRxChains = Array of bytes to awaken specified NR Rx chains

   \return true if successful, false if fail.

   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_NR5G_WAKEUP(
      HANDLE hResourceContext,
      byte wakeupMode,
      byte* awakenRxDevices,
      byte awakenRxDevicesLen,
      byte* awakenRxChains,
      byte awakenRxChainsLen );

   /*******************************************************************************/
   /**
   QLIB_FTM_LTE_DEEP_SLEEP -

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] subscriber = subscriber to put to sleep

   \return true if successful, false if fail.

   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_DEEP_SLEEP( 
      HANDLE hResourceContext,
      byte sub );
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_WAKEUP(
      HANDLE hResourceContext,
      byte wakeupMode );

   /*******************************************************************************/
   /**
   QLIB_FTM_LTE_CDTA_CONFIG -

   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] lte_cdta_config = config params for LTE CDTA

   \return true if successful, false if fail.

   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_CDTA_CONFIG(
      HANDLE hResourceContext,
      lte_cdta_config_params params );
   
   /********************************************************************************/
   /**
   QLIB_TRM_FORCE_TX_ANTENNA_SWITCH_SA_UL_MIMO API is used to force Tx antenna switch for SA UL MIMO case.
   
   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] iTx0Config = forced antenna config for Tx0 in online mode
   
   \param [in] iTx1Config = forced antenna config  for Tx1 in online mode
   
   antenna config:
      0x00: Disable forced config state
      0x01: Enable forced config state
      0x02: set forced config as config 0
      0x03: set forced config as config 1
      0x04: set forced config as config 2
      0x05: set forced config as config 3

   \return true if successful, false if fail.

   *******************************************************************************/
   
   QLIB_API unsigned char QLIB_TRM_FORCE_TX_ANTENNA_SWITCH_SA_UL_MIMO(  HANDLE hResourceContext,
                                                                        unsigned char iTx0Config,
                                                                        unsigned char iTx1Config );


   /********************************************************************************/
   /**
   QLIB_TRM_FORCE_TX_ANTENNA_SWITCH_SA_UL_MIMO_V2 API is used to force Tx antenna switch for SA UL MIMO case per sub/tech/cc.
   
   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [ASDIV_FORCED_UL_MIMO_CONFIG_TYPE] config = forced antenna config struct

   // Byte1: Tx Force config state
   // Byte2: UL MIMO config state
   // Byte3: Input Data Format
   // Byte4-11: Band No. (sys_band_class_e_type)
   // Byte12: Other input info, bits1-0: SUB ID, 0b01 = sub1, 0b10 = sub2, 0b00/0b11 = both sub1 and sub2, bits 7-2: Reserved

   \return true if successful, false if fail.

   *******************************************************************************/
   QLIB_API unsigned char QLIB_TRM_FORCE_TX_ANTENNA_SWITCH_SA_UL_MIMO_V2(  HANDLE hResourceContext,
                                                                           ASDIV_FORCED_UL_MIMO_CONFIG_TYPE config);
   
   
   /********************************************************************************/
   /**
   QLIB_TRM_SET_TX_ANTENNA_SWITCH_PER_RAT API is sets the forced configuration for a specific RAT/carrier at run time.
   
   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [in] iEnable = Enable/Disable rat based diag command config enforcement
   
   \param [in] carrierNum = number of carrier, (Maximum can be 7)

   \param [in] technology = current technology

   \param [in] antennaNumConfig = input config list
      input data format:
         bit 0 to 3: configuration
         bit 4 to 7: carrier ID.

   reference doc number: 80-NJ705-9

   \return true if successful, false if fail.

   *******************************************************************************/
   QLIB_API unsigned char QLIB_TRM_SET_TX_ANTENNA_SWITCH_PER_RAT(  HANDLE hResourceContext,
                                                                   unsigned char iEnable,
                                                                   unsigned char carrierNum,
                                                                   unsigned long technology,
                                                                   unsigned char* antennaNumConfig );

   /********************************************************************************/
   /**
   QLIB_TRM_SET_TX_ANTENNA_SWITCH_PER_RAT_V2 API is sets the forced configuration for a specific RAT/carrier/Sub at run time.
   
   \param hResourceContext = Resource context that was returned from the call to QLIB_ConnectServer()

   \param [ASDIV_FORCED_RAT_CARRIER_CONFIG_TYPE] config = forced antenna config struct

   // Byte1: Enable Input Size
   //    bit 0 to 3: RAT group (LTE/WCDMA/GSM, etc. RAT is defined as sys_sys_mode_e_type in modem_proc\mmcp\api\public\sys.h)
   //    bit 4 to 6: number of input
   //    bit 7th(msb bit)
   // Byte2: CCID config[0] 
   //    bits: 3-0: ASDIV Config/Port
   //    bits: 7-4: Carrier ID
   // Byte3: CCID config[1]
   // Byte4: CCID config[2]
   // Byte5: CCID config[3]
   ...
   // Byte7: CCID config[5]
   // Byte8: CCID config[6]
   // Byte9: Other Input info (bits 1-0: SUB ID, bits 7-2: Reserved)
   //    0b00/0b11- both sub1 and sub2
   //    0b01- sub1
   //    0b10- sub2
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_TRM_SET_TX_ANTENNA_SWITCH_PER_RAT_V2(  HANDLE hResourceContext,
                                                                      ASDIV_FORCED_RAT_CARRIER_CONFIG_TYPE config );
