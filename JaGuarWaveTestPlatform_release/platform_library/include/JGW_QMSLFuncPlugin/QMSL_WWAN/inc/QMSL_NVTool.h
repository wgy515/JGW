/******************************************************************************
 * $Header: //depot/HTE/QDART/QMSL6.1/QMSL_WWAN/inc/QMSL_NVTool.h#26 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \return true if result code is 0
   *******************************************************************************/
   QLIB_API unsigned char QLIB_NV_LoadNVsFromMobile_legacy(HANDLE hResourceContext, int* iNumOfNVItemValuesLoaded, int* iResultCode);
   /**
   QLIB_NV_LoadNVDefinition should be called first
   Read NV values from mobile.  The NV items to be read are from the definition list(s) loaded by QLIB_NV_LoadNVDefinition for NV IDs till 20000
   
   for NVItems with ID > 20000 : EFS call back is used to read 
   ...
   *******************************************************************************/
   ...
   \return true if result code is 0
   *******************************************************************************/
   QLIB_API unsigned char QLIB_NV_LoadNVItemsFromBDF(HANDLE hResourceContext, const char *sBDF_Path, int* iNumOfNVItemValuesLoaded, int iNVItemStart, int iNVItemStop, int* iResultCode);
