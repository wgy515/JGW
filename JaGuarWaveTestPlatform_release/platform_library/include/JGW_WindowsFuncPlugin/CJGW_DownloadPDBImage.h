...
namespace JGW
{
    class JGWWINDOWSFUNCPLUGIN_CLASS CCJGW_DownloadPDBImage : public CCJGW_PrsFlashDownloadBase
    {
    public:
        CCJGW_DownloadPDBImage(CCJGW_CSerialComPort& scp);
    ...
    private:
        //! 
        bool GetSerialNumberMacAddressPosToBin();
        //! 
