#pragma once
#include "CCJGW_CPUMemDiskStatusImp.h"
...
namespace JGW
{
    ...
    class CCPUMemDiskStatus : public CCJGW_CPUMemDiskStatusImp
    {
    public:
        CCPUMemDiskStatus();
        virtual ~CCPUMemDiskStatus();
    public:
        ...
        bool		SystemCpuInit(const std::vector<std::wstring>& vFullCounterPath);			//系统CPU使用率 设置检测开始点
