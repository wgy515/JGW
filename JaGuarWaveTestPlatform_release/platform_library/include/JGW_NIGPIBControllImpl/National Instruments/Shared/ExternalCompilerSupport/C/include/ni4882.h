...
//
typedef int (__stdcall * GpibNotifyCallback_t)(int, unsigned long, unsigned long, unsigned long, void *);
...
unsigned long __stdcall ibcmda   (int ud, const void * buf, size_t cnt);
...
unsigned long __stdcall iblck    (int ud, int v, unsigned int LockWaitTime, void * Reserved);
...
unsigned long __stdcall ibnotify (int ud, int mask, GpibNotifyCallback_t Callback, void * RefData);
...
unsigned long __stdcall ibrda    (int ud, void * buf, size_t cnt);
...
unsigned long __stdcall ibsad    (int ud, int v);
...
unsigned long __stdcall ibwrta   (int ud, const void * buf, size_t cnt);
