...
public:
...
#ifdef TIXML_USE_STL
	bool LoadFileBuffer(const std::string& strBuffer, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING);
#endif
	bool LoadFile(const char* buf,size_t length, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING);
	...
	*/
	...
	bool SaveFile( const char * filename,bool buseMicrosoftBOM ) 
	{
...
/*#include <string>*/
extern std::wstring GetElementTextValue( const TiXmlElement* pNode,const char* pNodeName,std::wstring& pNodeValue,const wchar_t* default = L"" );
extern std::wstring GetElementAttributeValue( const TiXmlElement* pNode,const char* pAttributeName,std::wstring& pAttributeValue ,const wchar_t* default = L"" );

//extern std::string GetElementTextValueA( const TiXmlElement* pNode,const char* pNodeName,std::string& pNodeValue,const char* default = "" );
//extern std::string GetElementAttributeValueA( const TiXmlElement* pNode,const char* pAttributeName,std::string& pAttributeValue ,const char* default = "" );

extern void SetElementTextValue(  TiXmlElement* pNode,const char* pNodeName,std::wstring pNodeValue );

extern void SetElementAttributeValue(  TiXmlElement* pNode,const char* pAttributeName,std::wstring pAttributeValue );

//extern void SetElementTextValueA(TiXmlElement* pNode,const char* pNodeName,const std::string& pNodeValue);

//extern void SetElementAttributeValueA(TiXmlElement* pNode,const char* pAttributeName,const std::string& pAttributeValue);

extern TiXmlElement* AddElementTextValue( TiXmlElement* pNode,const char* pNodeName,std::wstring pNodeValue );

extern void AddElementAttributeValue( TiXmlElement* pNode,const char* pAttributeName,std::wstring pAttributeValue );
#ifdef _MSC_VER
#pragma warning( pop )
#endif
